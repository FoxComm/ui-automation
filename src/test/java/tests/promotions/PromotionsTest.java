...
public class PromotionsTest extends DataProvider {
    ...
    public void addNewPromo() {
        ...
        sleep(3000);
        assertTrue( !p.promotionIdVal().equals("new"), "Failed to create new promotion." );
        String promotionId = p.promotionIdVal();
    ...
    public void editStorefrontName() throws IOException {
        ...
        click( p.promotionsNavMenu() );
        p.search(promotionId);
        assertEquals( p.getPromoParamVal("1", "Storefront Name"), "<p>Edited Promo Storefront Name</p>",
